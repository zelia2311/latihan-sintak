      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            ...
            <div className="text-lg font-black">Pengenalan awal</div>
            pengenalan yang di mulai
          </div>
          <hr />
        </li>
        <li>
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono italic">Rabu 2001</time>
        ...
        <li>
          ...
          <div className="timeline-end md:mb-10">
            <time className="font-mono italic">Kamis 2007</time>
